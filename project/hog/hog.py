...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            this_score0 = take_turn(num_rolls, score1, dice)
            score0 = score0 + this_score0
            if feral_hogs and abs(last_score0 - num_rolls) == 2:
                score0 += 3
            if is_swap(score0, score1):
                score0, score1 = score1, score0
            who, last_score0 = 1, this_score0
        else:
            num_rolls = strategy1(score1, score0)
            this_score1 = take_turn(num_rolls, score0, dice)
            score1 = score1 + this_score1
            if feral_hogs and abs(last_score1 - num_rolls) == 2:
                score1 += 3
            if is_swap(score1, score0):
                score1, score0 = score0, score1
            who, last_score1 = 0, this_score1
        if turn == 0:
            helper = say(score0,score1)
        else:
            helper = helper(score0, score1)
        turn += 1
    # END PROBLEM 5
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def helper(score0, score1):
        last_score_local, running_high_local = last_score, running_high
        if who == 0:
            this = score0 - last_score_local 
            if this > running_high_local:
                print("{} point(s)! That's the biggest gain yet for Player {}".format(this, 0))
                running_high_local = this
            last_score_local = score0
        else:
            this = score1 - last_score_local
            if this > running_high_local:
                print("{} point(s)! That's the biggest gain yet for Player {}".format(this, 1))
                running_high_local = this
