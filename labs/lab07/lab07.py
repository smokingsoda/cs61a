def insert_into_all(item, nested_list):
    ...
    [[0], [0, 1, 2], [0, 3]]
    """
    return [[item] + index for index in nested_list]
def subseqs(s):
    ...
    if s == []:
        ...
        last = subseqs(s[1:])
        return last + insert_into_all(s[0],last)
def inc_subseqs(s):
    """Assuming that S is a list, return a nested list of all subsequences
...
def make_glookup(class_assignments):
    ...
    total1 = 0
    total2 = 0
    def helper(subject , score):
        nonlocal total1, total2
        total1 = total1 + score
        total2 = total2 + cs61a[subject]
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    if n == 1 or n == 2:
        return 1
    return sum([num_trees(n-index-1) * num_trees(index+1) for index in range(n-1)])
...
def make_advanced_counter_maker():
    ...
    def helper1():
        ...
        def helper2(request):
            ...
            elif request == 'global-count':
                global_count += 1
                return global_count
            elif request == 'reset':
                personal_count = 0
            elif request == 'global-reset':
                global_count = 0
        return helper2
    return helper1
